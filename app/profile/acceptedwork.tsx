...
const AcceptedWorksScreen = () => {
  ...
  useEffect(() => {
    const fetchAcceptedWorks = async () => {
      try {
        ...
        setAcceptedWorks(works.filter(Boolean));
      } catch (error) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.sectionTitle}>Your Accepted Works</Text>
...
export default AcceptedWorksScreen;
